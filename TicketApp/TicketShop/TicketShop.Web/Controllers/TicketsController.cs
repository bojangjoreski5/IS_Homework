...
namespace TicketShop.Web.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> AddTicketToCard([Bind("TicketId", "Quantity")] AddToShoppingCartDto item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,TicketName,TicketImage,TicketPrice,TicketDescription,TicketDate")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,TicketName,TicketImage,TicketPrice,TicketDescription,TicketDate")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
